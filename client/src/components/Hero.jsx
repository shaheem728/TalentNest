  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
      ...
      <div className='flex items-center'>
        ...
        <input type='text' placeholder='Search for jobs' className='max-sm:text-xs p-2 rounded outline-none w-full bg-white text-gray-500'/>
      </div>
      <div className='flex items-center'>
        <img className='h-4 sm:h-5' src={assets.location_icon} alt=''/>
        <input type='text' placeholder='Location' className='max-sm:text-xs p-2 rounded outline-none w-full bg-white text-gray-500'/>
      </div>
